...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        int enterdID = Integer.parseInt(idField.getText());
        ProductCatalog productCat = supplier.getProductCatalog();
        Product p = productCat.searchProduct(enterdID);
        
        if (p == null){
            JOptionPane.showMessageDialog(this, "Product with this ID does not exist");
            return;
        }
